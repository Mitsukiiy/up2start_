...
import { arun, thirdweb } from "../assets";
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                ...
                "Your support can help turn a small spark of innovation into a blazing success,
                 empower a startup today and be a part of shaping the future!"
                </p>
              </div>
